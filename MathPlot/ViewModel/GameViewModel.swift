...
class GameViewModel {
    ...
    var paramA: Double = 0 { didSet { checkStarProximity() } }
    var paramB: Double = 0 { didSet { checkStarProximity() } }
    var paramH: Double = 0 { didSet { checkStarProximity() } }
    var paramK: Double = 0 { didSet { checkStarProximity() } }
    var stars: [Star] = []
    var isRunning: Bool = false
    var marbleX: Double = -5
    var marbleY: Double = 0
    var levelComplete: Bool = false
    var marbleTrail: [GraphPoint] = []
